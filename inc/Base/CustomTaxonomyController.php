...
class CustomTaxonomyController extends BaseController
{
    ...
    public function setSettings()
    {
        $args = array(
            array(
                'option_group'=>'book_plugin_tax_settings',
                'option_name'=>'book_plugin_tax',
    ...
    public function setSections()
    {
        $args = array(
            array(
                ...
                'callbacks'=>array($this->tax_callbacks, 'taxSectionManager'),
                'page'=>'book_taxonomy'
            )
        );
