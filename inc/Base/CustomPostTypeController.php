...
class CustomPostTypeController extends BaseController
{
    ...
    {
        $options = get_option('book_plugin_cpt') ?: array();
        ...
        foreach ($options as $option) {
            ...
            $this->custom_post_types[] = array(
                ...
                'singular_name'         => $option['plural_name'],
                'menu_name'             => $option['plural_name'],
                'name_admin_bar'        => $option['plural_name'],
                ...
                'not_found_in_trash'    => 'No '.$option['singular_name'].' Found in Tarsh',
                ...
                'items_list_navigation' => $option['plural_name'].' Lists Navigations',
                'filter_items_list'     => 'Filtered '.$option['plural_name'].' Lists',
