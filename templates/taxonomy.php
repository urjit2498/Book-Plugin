<div class="wrap">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="<?php echo isset($_POST["edit_taxonomy"])? 'active' :'' ?>">
            <a href="#tab-2">
                <?php echo isset($_POST["edit_taxonomy"])? 'Edit ' :'Add ' ?>
                Taxonomy
            </a>
        </li>
        <li>
    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane <?php echo !isset($_POST["edit_taxonomy"])? 'active' :'' ?>">
            ...
            <?php
                ...
                //     echo'<form method="post" action="" class="inlineBlock">';
                //     echo'<input type="hidden" name="edit_post" value="'.$option['post_type'].'">';
                //     submit_button('Edit', 'primary small', 'submit', false);
                //     echo'</form> ';

                //     echo'<form method="post" action="options.php" class="inlineBlock">';
            ...
            ?>
            <?php 
                $options = get_option( 'book_plugin_tax' ) ?: array();
                ...
                foreach ($options as $option) {
                    ...
                    settings_fields( 'book_plugin_tax_settings' );
        ...
        <div id="tab-2" class="tab-pane <?php echo isset($_POST["edit_taxonomy"])? 'active' :'' ?>">
            <form method="post" action="options.php">
                <?php
                    settings_fields('book_plugin_tax_settings');
                    do_settings_sections('book_taxonomy');
                    submit_button();
                ?>
            </form>
        </div>
